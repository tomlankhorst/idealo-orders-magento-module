...
class Idealo_Direktkauf_Model_Cronjobs_ImportOrders extends Idealo_Direktkauf_Model_Cronjobs_Base
{
     ...
     * @return string
     */
    protected function _getOrderStatusInfo($aOrder)
    {
    ...
    protected function _addQuote($aOrder)
    {
        ...
        #$aQuote['remote_ip'] = '192.168.2.191';
        ...
        #$aQuote['customer_prefix'] = NULL;
        $aQuote['customer_firstname'] = $aOrder['billing_address']['given_name'];
        #$aQuote['customer_middlename'] = NULL;
        $aQuote['customer_lastname'] = $aOrder['billing_address']['family_name'];
        #$aQuote['customer_suffix'] = NULL;
        #$aQuote['customer_dob'] = NULL;
        #$aQuote['customer_note'] = NULL;
    ...
    protected function _addQuoteAddress($aOrder, $iQuoteId, $sType)
    {
        ...
        $dBrutOrderSum = $aOrder['total_price'];
        $dNetOrderSum = $this->_getNetPrice($dBrutOrderSum, $aOrder['vat_rate']);
        $dVatOrderSum = $dBrutOrderSum - $dNetOrderSum;
        ...
        $aAddress['street'] = $aOrder[$sKey]['address1'];
        $aAddress['city'] = $aOrder[$sKey]['city'];
        #$aAddress['region'] = 'Berlin';
        #$aAddress['region_id'] = '82';
        ...
        $aAddress['grand_total'] = $blIsShipping ? $dBrutOrderSum : 0;
        $aAddress['base_grand_total'] = $blIsShipping ? $dBrutOrderSum : 0;
        $aAddress['applied_taxes'] = 'a:0:{}';// is this needed? big serialized array included normally
        $aAddress['subtotal_incl_tax'] = $blIsShipping ? $dBrutOrderSum: 0;
    ...
    protected function _addQuoteItem($aOrder, $aOrderItem, $iQuoteId)
    {
        ...
        $dBrutPrice = $aOrderItem['price'];
        $dTotalBrutPrice = $dBrutPrice * $aOrderItem['quantity'];
    ...
    protected function _handleOrder($aOrder, $iQuoteId)
    {
        ...
        $aShopOrder['base_grand_total'] = $dBrutOrderSum;
        $aShopOrder['grand_total'] = $dBrutOrderSum;
        $aShopOrder['base_subtotal_incl_tax'] = $dBrutOrderSum;
        $aShopOrder['subtotal_incl_tax'] = $dBrutOrderSum;
        ...
        $aShopOrder['base_subtotal'] = $dNetOrderSum;
        $aShopOrder['subtotal'] = $dNetOrderSum;
        ...
        #$aShopOrder['coupon_code'] = NULL;
        #$aShopOrder['customer_id'] = NULL;
        #$aShopOrder['weight'] = '0';
        #$aShopOrder['customer_dob'] = '';
        #$aShopOrder['applied_rule_ids'] = NULL;
        #$aShopOrder['customer_middlename'] = NULL;
        #$aShopOrder['customer_prefix'] = NULL;
        #$aShopOrder['customer_suffix'] = NULL;
        #$aShopOrder['customer_taxvat'] = NULL;
        #$aShopOrder['discount_description'] = NULL;
        #$aShopOrder['remote_ip'] = NULL;
        #$aShopOrder['x_forwarded_for'] = NULL;
        #$aShopOrder['customer_note'] = NULL;
        #$aShopOrder['customer_gender'] = NULL;
        #$aShopOrder['gift_message_id'] = NULL;
    ...
    protected function _handleOrderarticles($aOrder, $aOrderarticle, $sOrderId)
    {
        ...
        $dBrutPrice = $aOrderarticle['price'];
        $dTotalBrutPrice = $dBrutPrice * $aOrderarticle['quantity'];
        $dNetPrice = $this->_getNetPrice($dBrutPrice, $aOrder['vat_rate']);
        ...
        #$aOrderItem['product_options'] = '';// is this needed? Big serialized array included normally
        $aOrderItem['weight'] = '1';
        $aOrderItem['is_virtual'] = '0';
        $aOrderItem['sku'] = $aOrderarticle['sku'];
        $aOrderItem['name'] = $aOrderarticle['title'];
        #$aOrderItem['description'] = NULL;
        #$aOrderItem['applied_rule_ids'] = NULL;
        #$aOrderItem['additional_data'] = NULL;
        $aOrderItem['is_qty_decimal'] = '0';
        #$aOrderItem['qty_backordered'] = NULL;
        $aOrderItem['qty_ordered'] = $aOrderarticle['quantity'];
        #$aOrderItem['base_cost'] = NULL;
        ...
        #$aOrderItem['base_tax_before_discount'] = NULL;
        #$aOrderItem['tax_before_discount'] = NULL;
        ...
        #$aOrderItem['gift_message_id'] = NULL;
        ...
        if ($sParentId !== false) {
            ...
            #$aOrderItem['base_original_price'] = NULL;
            ...
            #$aOrderItem['base_tax_before_discount'] = NULL;
            #$aOrderItem['tax_before_discount'] = NULL;
            #$aOrderItem['price_incl_tax'] = NULL;
            #$aOrderItem['base_price_incl_tax'] = NULL;
            #$aOrderItem['row_total_incl_tax'] = NULL;
            #$aOrderItem['base_row_total_incl_tax'] = NULL;
            #$aOrderItem['hidden_tax_amount'] = NULL;
            #$aOrderItem['base_hidden_tax_amount'] = NULL;
            $aOrderItem['is_nominal'] = '0';
            #$aOrderItem['gift_message_id'] = NULL;
            $aOrderItem['gift_message_available'] = '1';
            $aOrderItem['base_weee_tax_applied_amount'] = '0';
            #$aOrderItem['base_weee_tax_applied_row_amnt'] = NULL;
            $aOrderItem['weee_tax_applied_amount'] = '0';
            $aOrderItem['weee_tax_applied_row_amount'] = '0';
            $aOrderItem['weee_tax_applied'] = 'a:0:{}';
            $aOrderItem['weee_tax_disposition'] = '0';
    ...
    public function start()
    {
        if ($this->_connectionDataIsSet()) {
            ...
            $this->_sendConnectionDataMisssingError();
        }
    }
